...
async (page) => {
  ...
  ghi('2D mặc định: tab 2D selected, 3D tabIndex=-1, panel 3D hidden, 12 nút nhanh + 12 phần tử data-name-vi, trạng thái "Đang ghép"',
  ...
  ghi('Bàn phím danh sách bộ phận: Enter chọn bánh lắc + link /tu-dien/day-toc-banh-lac',
    kb3.vi === 'Bánh lắc + dây tóc' && kb3.link === '/tu-dien/day-toc-banh-lac' && kb3.pressed === 'true', JSON.stringify(kb3));
