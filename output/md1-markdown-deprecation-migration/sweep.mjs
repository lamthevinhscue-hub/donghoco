// MD1 — sweep định dạng + JSON + nhạy cảm trên tệp gói
import { readFileSync, existsSync, readdirSync } from 'node:fs';

const goi = 'output/md1-markdown-deprecation-migration';
const files = [
  'docs/nghiem-thu/MD1-di-tru-markdown-remark-astro7-2026-09-20.md',
  'astro.config.mjs',
