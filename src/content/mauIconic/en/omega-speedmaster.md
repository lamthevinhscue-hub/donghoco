...
sources:
  ...
  - label: "Omega — Speedmaster collection"
    url: "https://www.omegawatches.com/en-us/watches/speedmaster"
  - label: "Omega — Chronicle, official brand archive"
    url: "https://www.omegawatches.com/chronicle"
  - label: "Omega — Moonwatch Calibre 3861 and Co-Axial escapement user manual (PDF)"
...
- **Black dial** with baton markers and the characteristic "baton" hands.
- **Three sub-dials**: running seconds, chronograph minutes, chronograph hours.
- A **tachymeter bezel** — the origin of the name "Speedmaster".
- The twisted **lyre lugs** of the later generations.
...
The Speedmaster proved a watch can be both a professional tool and a cultural symbol. For anyone who loves mechanical watches, experiencing a Speedmaster at least once is part of the education.
