---
title: "Rolex GMT-Master — the watch built for long-haul pilots"
custom_slug: "rolex-gmt-master"
excerpt: "Created for civil aviation, reading two time zones at once with a GMT hand and a two-colour 24-hour bezel. Its successor, the GMT-Master II (1982), added an independently adjustable local hour hand."
brand: "Rolex"
year: 1955
category: "pilot"
date: "2026-09-01"
...
- **A triangular-tipped GMT hand** — an additional hand completing one revolution in 24 hours (half the speed of the regular hour hand), read against the bezel.
- **A bidirectional 24-hour bezel** — engraved with a 24-hour scale, rotatable in both directions to align with the time zone being read.
- **A red-and-blue bezel** — the two halves make day and night hours distinguishable at a glance on the dial.
- The **Oyster case** — Rolex's waterproof case platform, at home in the cockpit and outside it.

## GMT-Master and GMT-Master II — what exactly changed?

In **1982**, Rolex introduced the **GMT-Master II**. The core difference is how the local hour hand is set:

- **The original GMT-Master** — the 24-hour hand is fixed to the hour-hand mechanism; setting local time means setting the whole hand set together.
- **The GMT-Master II** — the local hour hand jumps **independently, hour by hour**, without stopping the movement and without disturbing the minute hand or the 24-hour hand. After an overnight flight, the pilot simply turns the hour hand to the new local time — the 24-hour hand keeps the original reference time.

In other words: the original GMT-Master reads two time zones, while the GMT-Master II lets you **change local time quickly** while keeping the reference zone — exactly the need of someone flying continuously.
