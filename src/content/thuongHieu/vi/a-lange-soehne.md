...
signature_calibres: ["L121.1", "L951.6", "L043", "L951.5"]
date: "2026-07-31"
draft: false
...
lineHistory:
  ...
  - year: 2009
    title: "Zeitwerk — đồng hồ số nhảy cơ học duy nhất thế giới"
    detail: "Zeitwerk với caliber L043.5 — hiển thị giờ/phút bằng 'bảng số' lớn nhảy cơ học (không phải kim). Hệ thống 'constant force' đảm bảo nhảy chính xác mỗi phút — độc nhất vô nhị."
  - year: 2019
    title: "Datograph Up/Down L951.6 — kỷ niệm 20 năm"
    detail: "Kỷ niệm 20 năm Datograph bằng phiên bản Up/Down với indicator trữ cót, vỏ 41mm — tiếp tục khẳng định 'đỉnh chronograph' Đức."
  - year: 2023
    title: "Odysseus — sport-luxury đầu tiên của Lange"
    detail: "Mở rộng sang sport-luxury với Odysseus — vỏ thép sport, bracelet tích hợp, caliber L155.1. Gây tranh cãi trong fan lâu năm (Lange = dress watch) nhưng thành công thương mại."
collections:
  - name: "LANGE 1"
    year: 1994
