// =============================================================================
// DỮ LIỆU SƠ ĐỒ TIẾN HÓA ROLEX SUBMARINER (thí điểm)
// =============================================================================
...
export interface SubmarinerMilestone {
  ...
  note: string;
  /** Nguồn xác nhận (URL truy cập 30/08/2026) */
  sourceUrl: string;
  /** Tên tổ chức nguồn, hiện cho người đọc bên cạnh "Xem nguồn" */
  sourceName: string;
}

export const submarinerEvolution: SubmarinerMilestone[] = [
  {
    year: 1953,
    reference: '6204',
    label: 'Khởi đầu dòng',
