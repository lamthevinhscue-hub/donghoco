...
export const ARTICLE_PAIRS: RoutePair[] = [
  ...
  // P0-D2 — mở rộng từ điển đợt 1 (12 mục)
  { vi: '/tu-dien/bien-do', en: '/en/glossary/amplitude/' },
  { vi: '/tu-dien/tinh-dang-thoi', en: '/en/glossary/isochronism/' },
  { vi: '/tu-dien/sai-so-vi-tri', en: '/en/glossary/positional-error/' },
  { vi: '/tu-dien/dieu-chinh-theo-vi-tri', en: '/en/glossary/adjustment-in-positions/' },
  { vi: '/tu-dien/banh-xe-cot', en: '/en/glossary/column-wheel/' },
  { vi: '/tu-dien/flyback', en: '/en/glossary/flyback/' },
  { vi: '/tu-dien/rattrapante', en: '/en/glossary/rattrapante/' },
  { vi: '/tu-dien/lich-nam', en: '/en/glossary/annual-calendar/' },
  { vi: '/tu-dien/gio-the-gioi', en: '/en/glossary/world-time/' },
