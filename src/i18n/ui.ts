...
export const translations = {
  vi: {
    ...
    nav_contact: 'Liên hệ',
    nav_primary: 'Điều hướng chính',
    nav_breadcrumb: 'Đường dẫn trang',
    nav_anatomy: 'Giải phẫu',
    nav_learning_path: 'Lộ trình học',
  ...
  en: {
    ...
    subscribe_desc: 'Follow via RSS — open the feed in an RSS reader to know when new articles are published.',
    // subscribe_email + subscribe_button: tạm không dùng (form bản tin đã vô hiệu hóa).
    // Giữ lại để khi bật tính năng bản tin thì chỉ cần khôi phục form trong Footer.astro.
    contact_name: 'Name',
    contact_email: 'Email',
...
const glossaryCategoryLabels: Record<string, { vi: string; en: string }> = {
  ...
  'độ chính xác và điều chỉnh': { vi: 'Độ chính xác & điều chỉnh', en: 'Accuracy & regulation' },
};
